...
var operationRolesBearerAuth = map[string][]string{
	...
	CreateAgenticApplicationOperation:  []string{},
	DeleteAgentOperation:               []string{},
	DeleteAgenticApplicationOperation:  []string{},
	GetAgentOperation:                  []string{},
	GetAgenticApplicationOperation:     []string{},
	GetServiceProviderConfigOperation:  []string{},
	ListAgenticApplicationsOperation:   []string{},
	ListAgentsOperation:                []string{},
	PatchAgentOperation:                []string{},
	PatchAgenticApplicationOperation:   []string{},
	ReplaceAgentOperation:              []string{},
	ReplaceAgenticApplicationOperation: []string{},
}
